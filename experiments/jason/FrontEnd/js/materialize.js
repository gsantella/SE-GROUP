...
case 'transform':
 ...
 case '+':
    ...
    a = a.points; for (var c = 0, d, b = 0; b < a.numberOfItems; b++) {
      let f = a.getItem(b); b > 0 && (c += F(d, f)); d = f;
    } return c;
  } function N(a) {
...
case 'x':
    ...
    let c = P(a); return c.map((a, b) => {
      return { target: a, id: b, total: c.length };
    });
  } function aa(a, c) {
    let d = C(c); if (h.arr(a)) {
      let b = a.length; b !== 2 || h.obj(a[0]) ? h.fnc(c.duration) || (d.duration = c.duration / b) : a = { value: a };
    } return m(a).map((a, b) => {
    ...
    let f = 'delay' === a; return c.length ? (f ? Math.min : Math.max).apply(Math, c.map((b) => {
      return b[a];
 ...
 children: [], animatables: b, animations: a, duration: R('duration', a, c, d), delay: R('delay', a, c, d) 
    ...
    function c() {
      ...
      let a = v.indexOf(g); a > -1 && v.splice(a, 1); g.paused = !0;
    }; g.play = function () {
  ...
  const Dropdown = (function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleDropdownKeydown(e) {
        ...
        let nonLetters = [9, 13, 27, 38, 40];
        if (letter && nonLetters.indexOf(e.which) === -1) {
          this.filterQuery.push(letter);

          const string = this.filterQuery.join('');
          let newOptionEl = $(this.dropdownEl).find('li').filter((el) => $(el).text().toLowerCase().indexOf(string) === 0)[0];
  ...
  const Tooltip = (function (_Component7) {
    ...
    _createClass(Tooltip, [{
      ...
      value: function _positionTooltip() {
        ...
        let originHeight = origin.offsetHeight;
        let originWidth = origin.offsetWidth;
        let tooltipHeight = tooltip.offsetHeight;
        let tooltipWidth = tooltip.offsetWidth;
        let newCoordinates = void 0;
        let {margin} = this.options;
  ...
  const ScrollSpy = (function (_Component9) {
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _handleWindowScroll() {
        ...
        let left = M.getDocumentScrollLeft();
      ...
      value: function _findElements(top, right, bottom, left) {
        ...
        for (let i = 0; i < ScrollSpy._elements.length; i++) {
          ...
          if (scrollspy.$el.height() > 0) {
            ...
            let elLeft = scrollspy.$el.offset().left;
            let elRight = elLeft + scrollspy.$el.width();
            let elBottom = elTop + scrollspy.$el.height();
  ...
  const Autocomplete = (function (_Component10) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function _handleInputKeydown(e) {
        ...
        let numItems = $(this.container).children('li').length;
      ...
      value: function _highlight(string, $el) {
        ...
        let beforeMatch = $el.text().slice(0, matchStart);
        let matchText = $el.text().slice(matchStart, matchEnd + 1);
        let afterMatch = $el.text().slice(matchEnd + 1);
  ...
  const Datepicker = (function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function render(year, month, randId) {
        ...
        let now = new Date();
        let days = Datepicker._getDaysInMonth(year, month);
        ...
        let daysInPreviousMonth = Datepicker._getDaysInMonth(yearOfPreviousMonth, previousMonth);
        ...
        for (let i = 0, r = 0; i < cells; i++) {
          ...
          let isSelected = Datepicker._isDate(this.date) ? Datepicker._compareDates(day, this.date) : false;
          let isToday = Datepicker._compareDates(day, now);
          let hasEvent = opts.events.indexOf(day.toDateString()) !== -1;
          let isEmpty = i < before || i >= days + before;
          let dayNumber = 1 + (i - before);
          let monthNumber = month;
          let yearNumber = year;
          let isStartRange = opts.startRange && Datepicker._compareDates(opts.startRange, day);
          let isEndRange = opts.endRange && Datepicker._compareDates(opts.endRange, day);
          let isInRange = opts.startRange && opts.endRange && opts.startRange < day && day < opts.endRange;
          let isDisabled = opts.minDate && day < opts.minDate || opts.maxDate && day > opts.maxDate || opts.disableWeekends && Datepicker._isWeekend(day) || opts.disableDayFn && opts.disableDayFn(day);
  ...
  const Timepicker = (function (_Component16) {
    ...
    _createClass(Timepicker, [{
      ...
      value: function showView(view, delay) {
        ...
        let nextView = isHours ? this.hoursView : this.minutesView;
        let hideView = isHours ? this.minutesView : this.hoursView;
      ...
      value: function resetClock(delay) {
        ...
        let radius = isHours && value > 0 && value < 13 ? this.options.innerRadius : this.options.outerRadius;
      ...
      value: function setHand(x, y, roundBy5) {
        ...
        let isHours = this.currentView === 'hours';
        let unit = Math.PI / (isHours || roundBy5 ? 6 : 30);
        let z = Math.sqrt(x * x + y * y);
        let inner = isHours && z < (this.options.outerRadius + this.options.innerRadius) / 2;
        ...
        let cy1 = -Math.cos(radian) * (radius - this.options.tickRadius);
        let cx2 = Math.sin(radian) * radius;
        let cy2 = -Math.cos(radian) * radius;
  ...
  const CharacterCounter = (function (_Component17) {
    ...
    _createClass(CharacterCounter, [{
      ...
      value: function updateCounter() {
        ...
        let actualLength = this.el.value.length;
